  ...
  ttlFiles.forEach(async f => {
    ...
    await compacted['@graph'].forEach(graph => {
      ...
      const type = Array.isArray(properties.type)
        ...
        : properties.type;
      const owlTypes = (!properties.type ? [] : Array.isArray(properties.type) ? properties.type : [properties.type])
        .filter(t => t.indexOf('http://www.w3.org/2002/07/owl#') === 0)
        .map(t => t.replace('http://www.w3.org/2002/07/owl#',''));
/*
[
  'Concept',
  ...
  'http://www.w3.org/2002/07/owl#FunctionalProperty'
      ...
      const owlTypes = Array.isArray(properties.type)
